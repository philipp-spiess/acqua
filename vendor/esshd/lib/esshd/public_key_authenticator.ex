...
defmodule Sshd.PublicKeyAuthenticator.AcceptAll do
  @moduledoc """
  Public key authenticator that accepts all users without requiring key verification.
  """
  use Sshd.PublicKeyAuthenticator

  def authenticate(_username, _public_key, _opts), do: true
end
